...
cd
git clone https://github.com/aboul3la/Sublist3r.git ~/tools/Sublist3r 2> /dev/null &> /dev/null
cd ~/tools/Sublist3r
sudo pip3 install -r requirements.txt 2> /dev/null &> /dev/null

echo -e "- Installing sqlmap"
cd
git clone --depth 1 https://github.com/sqlmapproject/sqlmap.git ~/tools/sqlmap/ 2> /dev/null &> /dev/null
# cd && git clone https://github.com/w9w/JSA.git ~/tools/JSA/ 2> /dev/null

echo -e "- Installing urldedupe"
cd
git clone https://github.com/ameenmaali/urldedupe.git ~/tools/.tmp/urldedupe 2> /dev/null &> /dev/null
cd ~/tools/.tmp/urldedupe
cmake CMakeLists.txt 2> /dev/null &> /dev/null
make 2> /dev/null &> /dev/null
mv urldedupe /usr/bin/ 2> /dev/null &> /dev/null
...
cd ~/tools/.tmp/
git clone https://github.com/ffuf/ffuf 2> /dev/null &> /dev/null
cd ffuf
go install 2> /dev/null &> /dev/null

echo -e "- Installing dnsx"
cd ~/tools/.tmp/
git clone https://github.com/projectdiscovery/dnsx.git 2> /dev/null &> /dev/null
cd dnsx/cmd/dnsx
go install 2> /dev/null &> /dev/null

echo -e "- Installing notify"
cd ~/tools/.tmp/
git clone https://github.com/projectdiscovery/notify.git 2> /dev/null &> /dev/null
cd notify/cmd/notify
go build
mv notify /usr/bin/ 2> /dev/null

echo -e "- Installing dalfox"
cd ~/tools/.tmp/
git clone https://github.com/hahwul/dalfox 2> /dev/null &> /dev/null
cd dalfox
go install 2> /dev/null &> /dev/null

echo -e "- Installing crlfuzz"
cd ~/tools/.tmp/
git clone https://github.com/dwisiswant0/crlfuzz 2> /dev/null &> /dev/null
cd crlfuzz/cmd/crlfuzz
go install 2> /dev/null &> /dev/null

echo -e "- Installing nuclei"
cd ~/tools/.tmp/
git clone https://github.com/projectdiscovery/nuclei.git 2> /dev/null &> /dev/null
...
cd ~/tools/.tmp/
wget https://github.com/OWASP/Amass/releases/download/v3.12.3/amass_linux_i386.zip 2> /dev/null &> /dev/null
unzip amass_linux_i386.zip 2> /dev/null &> /dev/null
cd amass_linux_i386
mv amass /usr/bin/ 2> /dev/null &> /dev/null
